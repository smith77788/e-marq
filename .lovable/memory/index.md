...
- [MARQ implementation roadmap](mem://features/marq-roadmap) — Sprints 1-10 ✅ закриті (catalog v2, storefront, email, promotions+loyalty, UA payments, ACOS-агенти, bulk промокоди). Sprint 11 заплановано: White-label Site Builder — бренд генерує власний сайт на базі MFD-шаблону (project a74eaa2d-62ac-4a30-98d6-1c37f45f6f79), результат у вигляді ZIP-архіву, без MARQ-секретів.
