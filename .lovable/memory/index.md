...
- [Telegram polling cadence](mem://features/telegram-polling) — cron `marq-telegram-poll-1min` `* * * * *` timeout 35s; MAX_RUNTIME_MS=25s, getUpdates timeout=20s; ↓latency з 1-2хв до 0-60с
