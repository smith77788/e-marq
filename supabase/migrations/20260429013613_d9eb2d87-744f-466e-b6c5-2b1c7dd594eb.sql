...
BEGIN
  FOR d IN
    ...
    LIMIT 200
  LOOP
    -- For synthetic data: anchor at last order date if executed_at is in the future relative to data
    ...
    INSERT INTO action_outcomes (
      ...
      now(),
      'demo-measured (synthetic dataset) by demo_measure_recent_outcomes()'
    );
