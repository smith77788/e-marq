  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>14 днів</strong>, ми повертаємо 100% коштів без зайвих питань — за умови, що ви
        не використали MARQ для надсилання комерційних повідомлень понад 100 одержувачам.
      </p>

      <h2>2. Скасування підписки</h2>
      <p>
        Скасуйте підписку у будь-який час у панелі білінгу. Ви матимете доступ до сервісу до
        кінця оплаченого періоду. Часткові повернення за невикористані дні в межах місяця за
        замовчуванням не виплачуються.
      </p>
      ...
      <p>
        Якщо MARQ був недоступний понад 24 години поспіль через нашу провину, ми надамо
        компенсацію — кредит на наступний місяць пропорційно тривалості простою.
      </p>
    </>
  );
}
...
function RefundEN() {
  return (
    <>
      ...
      <p>
        If you paid for a plan for the first time and want out within{" "}
        <strong>14 days</strong>, we'll refund 100% — provided you haven't used MARQ to send
        commercial messages to more than 100 recipients.
      </p>

      <h2>2. Subscription cancellation</h2>
      <p>
        Cancel any time from the billing panel. You retain access until the end of the paid
        period. We don't pro-rate refunds for unused days in the current month by default.
      </p>
      ...
      <p>We respond within 5 business days. Refunds are issued through the original payment method.</p>
