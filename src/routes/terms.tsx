...
function TermsUA() {
  return (
    <>
      ...
      <p>
        MARQ працює за моделлю підписки. Безкоштовний тариф (Free) діє безстроково, у межах
        квот. Платні тарифи (Starter, Growth, Scale) виставляються щомісячно за бренд.
      </p>
      <ul>
      ...
      <p>
        ...
        вашою власністю. Ми обробляємо їх виключно для надання сервісу. Ви можете експортувати
        свої дані будь-коли.
      </p>

      <h2>4. ШІ-агенти та автоматизація</h2>
      <p>
        MARQ використовує великі мовні моделі для автоматизації маркетингових і операційних
        задач. Ми не гарантуємо безпомилкову роботу ШІ. Усі автоматизації, що генерують
        фінансові операції (оплати, рекламні бюджети), вимагають вашого явного підтвердження.
      </p>
      ...
      <p>
        Ми можемо призупинити або закрити акаунт у разі порушення цих умов. Ви можете закрити
        акаунт у будь-який час із панелі налаштувань — дані видаляються протягом 30 днів.
      </p>
      ...
      <h2>8. Зміни умов</h2>
      <p>
        Ми можемо оновлювати ці умови. Про істотні зміни ми повідомимо за 14 днів на email.
        Подальше використання сервісу означає згоду з оновленими умовами.
      </p>

      <h2>9. Право та юрисдикція</h2>
      <p>
        Ці умови регулюються правом України. Спори вирішуються переговорами; за відсутності
        згоди — у судах за місцем реєстрації MARQ.
      </p>
    </>
  );
}
...
function TermsEN() {
  return (
    <>
      ...
      <p>
        MARQ is a SaaS platform for business owners and their teams. You must be of legal age or
        a registered legal entity. By creating an account, you confirm that the data you provide
        is accurate and that you have the authority to represent the brand you add.
      </p>

      <h2>2. Plans and billing</h2>
      <p>
        MARQ runs on a subscription model. The Free tier is permanent within its quotas. Paid
        tiers (Starter, Growth, Scale) are billed monthly per brand.
      </p>
      <ul>
      ...
      <p>
        All data you upload to MARQ (products, customers, orders, media) remains your property.
        We process it solely to provide the service. You can export your data at any time.
      </p>

      <h2>4. AI agents and automation</h2>
      <p>
        MARQ uses large language models to automate marketing and operations. We don't guarantee
        flawless AI behavior. Any automation that triggers financial actions (payments, ad
        spend) requires your explicit confirmation.
      </p>
      ...
      <p>
        We may suspend or close an account that violates these terms. You may close your account
        at any time from settings — data is deleted within 30 days.
      </p>

      <h2>7. Limitation of liability</h2>
      <p>
        The service is provided "as is". MARQ is not liable for indirect or consequential
        damages. MARQ's total liability is limited to fees paid in the last 3 months.
      </p>

      <h2>8. Changes to these terms</h2>
      <p>
        We may update these terms. Material changes will be communicated by email at least 14
        days in advance. Continued use of the service constitutes acceptance.
      </p>

      <h2>9. Governing law</h2>
      <p>
        These terms are governed by the laws of Ukraine. Disputes are resolved through
        negotiation first; failing that, by courts at MARQ's place of registration.
      </p>
    </>
  );
}
