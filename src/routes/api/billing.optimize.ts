/**
 * GET /api/billing/optimize?tenantId=xxx — аналіз підписки тенанта.
 *
...
import { analyzeSubscription } from "@/lib/acos/billingOptimization";
...
export const Route = createFileRoute("/api/billing/optimize")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        const analysis = await analyzeSubscription(tenantId);
