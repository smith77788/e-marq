/**
 * GET /api/reviews/candidates?tenantId=xxx — клієнти для запиту відгуку.
 *
...
import { getReviewRequestCandidates } from "@/lib/acos/reviewCollection";
...
export const Route = createFileRoute("/api/reviews/candidates")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        const candidates = await getReviewRequestCandidates(tenantId);
