/**
 * GET /api/inventory/forecast?tenantId=xxx — inventory demand forecasts for a tenant.
 *
...
import { forecastInventory } from "@/lib/acos/inventoryForecast";
...
export const Route = createFileRoute("/api/inventory/forecast")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        return Response.json({ ok: true, forecasts });
      },
    },
  },
});
