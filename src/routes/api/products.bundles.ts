/**
 * GET /api/products/bundles?tenantId=xxx — bundle opportunities for a tenant.
 *
...
import { findBundleOpportunities } from "@/lib/acos/productBundles";
...
export const Route = createFileRoute("/api/products/bundles")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        const bundles = await findBundleOpportunities(tenantId);
