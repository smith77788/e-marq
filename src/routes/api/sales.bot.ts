/**
 * POST /api/sales/bot — run the autonomous sales bot for a tenant.
 *
...
export const Route = createFileRoute("/api/sales/bot")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const result = await runSalesBotForTenant(tenantId);
