/**
 * GET /api/pricing?tenantId=xxx — pricing recommendations for a tenant.
 *
...
import { analyzePricing } from "@/lib/acos/pricingEngine";
  ...
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        const recommendations = await analyzePricing(tenantId);
