/**
 * GET /api/social-proof?tenantId=xxx&productId=xxx — соціальні докази для товару.
 *
...
import { getProductSocialProof } from "@/lib/acos/socialProof";
  ...
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        const proofs = await getProductSocialProof(tenantId, productId);
