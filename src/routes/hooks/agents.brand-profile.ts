        ...
        try {
          ...
          if (!description) {
            insights.push({
              ...
              title: "Додайте tagline та опис бренду",
              description:
                "Без одного рядка tagline + 2-3 речень опису агенти broadcast/SEO повертаються до шаблонних текстів. Відкрийте Налаштування бренду → SEO і заповніть.",
              expected_impact: "Підіймає open-rate AI-розсилок на ~15%",
              confidence: 0.85,
              risk_level: "medium",
          ...
          if (categories.size === 0 && products.length > 0) {
            insights.push({
              ...
              title: "Позначте товари категоріями",
              description: `${products.length} товарів без категорії. Агенти bundle/cross-sell потребують категорій для підбору комбінацій.`,
              expected_impact: "Розблоковує bundle-рекомендації та product-affinity",
              confidence: 0.9,
              risk_level: "medium",
