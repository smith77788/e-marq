...
export function HandbookToc() {
  const { t } = useT();
  return (
    <nav aria-label="Зміст посібника" className="sticky top-4 hidden w-56 shrink-0 lg:block">
...
export function HandbookTocMobile() {
  const { t } = useT();
  return (
    <nav aria-label="Зміст посібника" className="lg:hidden -mx-4 overflow-x-auto px-4 pb-2">
