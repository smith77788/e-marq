    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-xs">
          ...
          додавання у кошик, покупки. Без нього ШІ-помічники працюють лише на старих даних.
          Доступна команда <code className="rounded bg-muted px-1 text-[11px]">MARQ.track(тип, дані)</code>{" "}
...
{snippet}
        ...
        <details className="rounded-md border border-dashed border-border bg-muted/20 p-3 text-xs">
          <summary className="cursor-pointer font-medium text-foreground">Як надсилати події вручну (приклади)</summary>
