...
const ORCHESTRATORS: AdminCommand[] = [
  {
    ...
    description:
      "Аналог щоденного крон-завдання. Проходить всі активні бренди та запускає для кожного повний пакет агентів.",
    scope: "global",
  },
  {
    id: "run-all",
...
const ENGINES: AdminCommand[] = [
  ...
  },
  {
    ...
    description:
      "Точкова відправка повідомлення повернення конкретному клієнту (потрібен customer_id).",
    scope: "tenant",
